...
public class GameConstant
{
	...
	public GameConstant(int boardLenght, int nbWizard, int levelMaxCost, int levelMaxDifficulty)
	{
		...
		Preconditions.checkArgument(levelMaxCost > 0, "levelMaxCost was %s but expected strictly positive", levelMaxCost);
		...
		this.levelMaxCost = levelMaxCost;
